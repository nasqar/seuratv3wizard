                                             ...
                                             tabPanel("Find all markers",
                                                      column(12,
                                                             column(8,
                                                                    wellPanel(
                                                                      h4("Find All Markers:"),
                                                                      column(4,numericInput("minPctAll", "Min % (min.pct)", value = 0.1)),
                                             ...
                                             tabPanel("Find markers by cluster",
                                                      ...
                                                      column(12,
                                                             wellPanel(
                                                               ...
                                                               column(4,numericInput("minPct", "Min % (min.pct)", value = 0.1)),
                                             ...
                                             tabPanel("Find markers by cluster vs other clusters",
                                                      column(12,
                                                             wellPanel(
                                                               ...
                                                               column(3,numericInput("minPctvs", "Min % (min.pct)", value = 0.1)),
